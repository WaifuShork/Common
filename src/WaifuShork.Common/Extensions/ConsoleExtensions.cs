// This code originates from silkfires Pastel library 
// Link: https://github.com/silkfire/Pastel/blob/master/src/ConsoleExtensions.cs
...
namespace WaifuShork.Common.Extensions
{
    ...
    public static class ConsoleExtensions
    {
        ...
        {
            [ColorPlane.Foreground] = new($"(?:{_formatStringEnd.Replace("[", @"\[")})(?!{string.Format(_formatStringStart.Replace("[", @"\["), _planeFormatModifiers[ColorPlane.Foreground])})(?!$)", RegexOptions.Compiled),
            [ColorPlane.Background] = new($"(?:{_formatStringEnd.Replace("[", @"\[")})(?!{string.Format(_formatStringStart.Replace("[", @"\["), _planeFormatModifiers[ColorPlane.Background])})(?!$)", RegexOptions.Compiled)
        });
        ...
        public static string ColorizeForeground(this string input, Color color)
        {
        ...
        public static string ColorizeForeground(this string input, string hexColor)
        {
        ...
        /// <param name="input">The string to color.</param>
        /// <param name="color">The color to use on the specified string.</param>
        public static string ColorizeBackground(this string input, Color color)
        {
        ...
        /// <param name="input">The string to color.</param>
        /// <param name="hexColor">The color to use on the specified string.<para>Supported format: [#]RRGGBB.</para></param>
        public static string ColorizeBackground(this string input, string hexColor)
        {
